...
public class Messages {
    public static String title="FEN2PDF    Mark Dechamps      (B)eer licensed 2024";
    ...
    public static String file_chooser_select_dir ="Select directory:";
    ...
    public static String failed_to_download_chessvision_ai="Failed to download with chessvision.ai as well.";
}
